...
%token  CONTINUE RETURN DOUBLE SWITCH CASE DEFAULT PRINTF ADDOP MULOP RELOP ASSIGNOP LOGICOP INT FLOAT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD IF ELSE FOR WHILE DO BREAK CONST_INT CONST_FLOAT INCOP DECOP CHAR VOID NOT SEMICOLON COMMA COLON ID GOTO 
